...
//   At: 2024-10-24T10:43:05.0286663-05:00
//
...
public partial class AutomationEntities
{
    ...
    ///<summary>Zone - Owen on Walk</summary>
    public AutomationEntity ZoneOwenOnWalk => new(_haContext, "automation.zone_owen_on_walk");
...
public partial class BinarySensorEntities
{
    ...
    ///<summary>Main Low battery level</summary>
    public BinarySensorEntity ClimateMainLowBatteryLevel => new(_haContext, "binary_sensor.climate_main_low_battery_level");
    ...
    ///<summary>Keypad temporary disabled</summary>
    ...
    ///<summary>Replace battery now</summary>
    ...
    ///<summary>Replace battery soon</summary>
    ...
    ///<summary>System hardware failure</summary>
    ...
    ///<summary>Main AC mains re-connected</summary>
    ...
    ///<summary>pve_cloudflared</summary>
    public BinarySensorEntity PveCloudflared => new(_haContext, "binary_sensor.pve_cloudflared");
    ///<summary>pve_dockge</summary>
    public BinarySensorEntity PveDockge => new(_haContext, "binary_sensor.pve_dockge");
    ///<summary>pve_HomeAssistant</summary>
    public BinarySensorEntity PveHomeassistant => new(_haContext, "binary_sensor.pve_homeassistant");
    ///<summary>pve_nextcloud</summary>
    public BinarySensorEntity PveNextcloud => new(_haContext, "binary_sensor.pve_nextcloud");
    ///<summary>pve_pihole</summary>
    public BinarySensorEntity PvePihole => new(_haContext, "binary_sensor.pve_pihole");
    ///<summary>pve_plex</summary>
    public BinarySensorEntity PvePlex => new(_haContext, "binary_sensor.pve_plex");
    ...
    ///<summary>Utility Room Lights Motion detection</summary>
    ...
    ///<summary>Garage Door Tilt Sensor Low battery level</summary>
    public BinarySensorEntity ZWavePlusGoldPlatedReliabilityGarageDoorTiltSensorLowBatteryLevel => new(_haContext, "binary_sensor.z_wave_plus_gold_plated_reliability_garage_door_tilt_sensor_low_battery_level");
    ///<summary>Garage Door Tilt Sensor Replace battery now</summary>
    public BinarySensorEntity ZWavePlusGoldPlatedReliabilityGarageDoorTiltSensorReplaceBatteryNow => new(_haContext, "binary_sensor.z_wave_plus_gold_plated_reliability_garage_door_tilt_sensor_replace_battery_now");
    ///<summary>Garage Door Tilt Sensor Tampering, product cover removed</summary>
    public BinarySensorEntity ZWavePlusGoldPlatedReliabilityGarageDoorTiltSensorTamperingProductCoverRemoved => new(_haContext, "binary_sensor.z_wave_plus_gold_plated_reliability_garage_door_tilt_sensor_tampering_product_cover_removed");
    ///<summary>Garage Door Tilt Sensor Window/door is open</summary>
    public BinarySensorEntity ZWavePlusGoldPlatedReliabilityGarageDoorTiltSensorWindowDoorIsOpen => new(_haContext, "binary_sensor.z_wave_plus_gold_plated_reliability_garage_door_tilt_sensor_window_door_is_open");
    ///<summary>Garage Door Tilt Sensor Window/door is open</summary>
    public BinarySensorEntity ZWavePlusGoldPlatedReliabilityGarageDoorTiltSensorWindowDoorIsOpen2 => new(_haContext, "binary_sensor.z_wave_plus_gold_plated_reliability_garage_door_tilt_sensor_window_door_is_open_2");
    ///<summary>Garage Door Tilt Sensor Window/door is open in regular position</summary>
    public BinarySensorEntity ZWavePlusGoldPlatedReliabilityGarageDoorTiltSensorWindowDoorIsOpenInRegularPosition => new(_haContext, "binary_sensor.z_wave_plus_gold_plated_reliability_garage_door_tilt_sensor_window_door_is_open_in_regular_position");
    ///<summary>Garage Door Tilt Sensor Window/door is open in tilt position</summary>
    public BinarySensorEntity ZWavePlusGoldPlatedReliabilityGarageDoorTiltSensorWindowDoorIsOpenInTiltPosition => new(_haContext, "binary_sensor.z_wave_plus_gold_plated_reliability_garage_door_tilt_sensor_window_door_is_open_in_tilt_position");
}
...
public partial class ButtonEntities
{
    ...
    public ButtonEntity BedroomFanPing => new(_haContext, "button.bedroom_fan_ping");
    ...
    ///<summary>Main Ping</summary>
    public ButtonEntity ClimateMainPing => new(_haContext, "button.climate_main_ping");
    ...
    public ButtonEntity DeckLightsPing => new(_haContext, "button.deck_lights_ping");
    ///<summary>Deck String Lights Identify</summary>
    ...
    ///<summary>Entry Lights Ping</summary>
    public ButtonEntity EntryLightsPing => new(_haContext, "button.entry_lights_ping");
    ///<summary>Idle Access Control Keypad state</summary>
    ...
    ///<summary>Idle Access Control Lock state</summary>
    ...
    ///<summary>Idle Home Security Sensor status</summary>
    ...
    ///<summary>Idle Power Management Battery maintenance status</summary>
    ...
    ///<summary>Idle System Hardware status</summary>
    ...
    public ButtonEntity GarageLightsIdleHomeSecurityMotionSensorStatus => new(_haContext, "button.garage_lights_idle_home_security_motion_sensor_status");
    ///<summary>Garage Lights Ping</summary>
    public ButtonEntity GarageLightsPing => new(_haContext, "button.garage_lights_ping");
    ///<summary>Hallway Lights Ping</summary>
    public ButtonEntity HallwayLightsPing => new(_haContext, "button.hallway_lights_ping");
    ...
    public ButtonEntity KitchenLightsPing => new(_haContext, "button.kitchen_lights_ping");
    ...
    ///<summary>Living Room Lamp 1 Identify</summary>
    public ButtonEntity LivingRoomLamp1Identify => new(_haContext, "button.living_room_lamp_1_identify");
    ///<summary>Living Room Lamp 1 Ping</summary>
    public ButtonEntity LivingRoomLamp1Ping => new(_haContext, "button.living_room_lamp_1_ping");
    ///<summary>Living Room Lamp 2 Ping</summary>
    public ButtonEntity LivingRoomLamp2Ping => new(_haContext, "button.living_room_lamp_2_ping");
    ///<summary>Main Identify</summary>
    ...
    public ButtonEntity Node26Ping => new(_haContext, "button.node_26_ping");
    ///<summary>Garage Door Tilt Sensor Ping</summary>
    ...
    public ButtonEntity UtilityRoomLightsIdleHomeSecurityMotionSensorStatus => new(_haContext, "button.utility_room_lights_idle_home_security_motion_sensor_status");
    ...
    ///<summary>Garage Door Tilt Sensor Idle Home Security Cover status</summary>
    public ButtonEntity ZWavePlusGoldPlatedReliabilityGarageDoorTiltSensorIdleHomeSecurityCoverStatus => new(_haContext, "button.z_wave_plus_gold_plated_reliability_garage_door_tilt_sensor_idle_home_security_cover_status");
    ///<summary>Garage Door Tilt Sensor Idle Power Management Battery maintenance status</summary>
    public ButtonEntity ZWavePlusGoldPlatedReliabilityGarageDoorTiltSensorIdlePowerManagementBatteryMaintenanceStatus => new(_haContext, "button.z_wave_plus_gold_plated_reliability_garage_door_tilt_sensor_idle_power_management_battery_maintenance_status");
}
...
public partial class EventEntities
{
    ...
    ///<summary>Bedroom Lights Scene ID</summary>
    public EventEntity BedroomLightsSceneId => new(_haContext, "event.bedroom_lights_scene_id");
    ///<summary>Counter Lights Event value</summary>
    public EventEntity CounterLightsEventValue3 => new(_haContext, "event.counter_lights_event_value_3");
    ///<summary>Counter Lights Scene 001</summary>
    public EventEntity CounterLightsScene0012 => new(_haContext, "event.counter_lights_scene_001_2");
    ...
    ///<summary>Counter Lights Scene ID</summary>
    public EventEntity CounterLightsSceneId3 => new(_haContext, "event.counter_lights_scene_id_3");
    ...
    ///<summary>Dining Room Lights Scene ID</summary>
    public EventEntity DiningRoomLightsSceneId => new(_haContext, "event.dining_room_lights_scene_id");
    ...
    ///<summary>Entry Lights Event value</summary>
    public EventEntity EntryLightsEventValue => new(_haContext, "event.entry_lights_event_value");
    ///<summary>Entry Lights Scene 001</summary>
    public EventEntity EntryLightsScene001 => new(_haContext, "event.entry_lights_scene_001");
    ///<summary>Entry Lights Scene 002</summary>
    public EventEntity EntryLightsScene002 => new(_haContext, "event.entry_lights_scene_002");
    ///<summary>Entry Lights Scene ID</summary>
    public EventEntity EntryLightsSceneId => new(_haContext, "event.entry_lights_scene_id");
    ...
    ///<summary>Front Porch Lights Scene ID</summary>
    public EventEntity FrontPorchLightsSceneId => new(_haContext, "event.front_porch_lights_scene_id");
    ///<summary>G4 Doorbell Pro Doorbell</summary>
    ...
    ///<summary>Garage Lights Scene ID</summary>
    public EventEntity GarageLightsSceneId => new(_haContext, "event.garage_lights_scene_id");
    ///<summary>Hallway Lights Event value</summary>
    public EventEntity HallwayLightsEventValue => new(_haContext, "event.hallway_lights_event_value");
    ///<summary>Hallway Lights Scene 001</summary>
    public EventEntity HallwayLightsScene001 => new(_haContext, "event.hallway_lights_scene_001");
    ///<summary>Hallway Lights Scene 002</summary>
    public EventEntity HallwayLightsScene002 => new(_haContext, "event.hallway_lights_scene_002");
    ///<summary>Hallway Lights Scene ID</summary>
    public EventEntity HallwayLightsSceneId => new(_haContext, "event.hallway_lights_scene_id");
    ...
    ///<summary>Kitchen Lights Scene ID</summary>
    public EventEntity KitchenLightsSceneId => new(_haContext, "event.kitchen_lights_scene_id");
    ...
    ///<summary>Living Room Lamp 1 Event value</summary>
    public EventEntity LivingRoomLamp1EventValue => new(_haContext, "event.living_room_lamp_1_event_value");
    ///<summary>Living Room Lamp 1 Scene 001</summary>
    public EventEntity LivingRoomLamp1Scene001 => new(_haContext, "event.living_room_lamp_1_scene_001");
    ///<summary>Living Room Lamp 1 Scene 002</summary>
    public EventEntity LivingRoomLamp1Scene002 => new(_haContext, "event.living_room_lamp_1_scene_002");
    ///<summary>Living Room Lamp 1 Scene ID</summary>
    public EventEntity LivingRoomLamp1SceneId => new(_haContext, "event.living_room_lamp_1_scene_id");
    ///<summary>Living Room Lamp 2 Scene ID</summary>
    public EventEntity LivingRoomLamp2SceneId => new(_haContext, "event.living_room_lamp_2_scene_id");
    ///<summary>Laundry Room Lights Scene 002</summary>
    public EventEntity Node5Scene002 => new(_haContext, "event.node_5_scene_002");
    ...
    ///<summary>Office Lights Scene ID</summary>
    public EventEntity OfficeLightsSceneId => new(_haContext, "event.office_lights_scene_id");
    ...
    ///<summary>Stairway Lights Scene ID</summary>
    public EventEntity StairwayLightsSceneId => new(_haContext, "event.stairway_lights_scene_id");
    ...
    ///<summary>Utility Room Lights Scene ID</summary>
    public EventEntity UtilityRoomLightsSceneId => new(_haContext, "event.utility_room_lights_scene_id");
}
...
public partial class InputBooleanEntities
{
    ...
    ///<summary>netdaemon_net_daemon_apps_lighting_vacation_lighting</summary>
    public InputBooleanEntity NetdaemonNetDaemonAppsLightingVacationLighting => new(_haContext, "input_boolean.netdaemon_net_daemon_apps_lighting_vacation_lighting");
    ...
    ///<summary>netdaemon_net_daemon_apps_state_home_state</summary>
    public InputBooleanEntity NetdaemonNetDaemonAppsStateHomeState => new(_haContext, "input_boolean.netdaemon_net_daemon_apps_state_home_state");
    ///<summary>netdaemon_net_daemon_apps_walk_walk</summary>
    public InputBooleanEntity NetdaemonNetDaemonAppsWalkWalk => new(_haContext, "input_boolean.netdaemon_net_daemon_apps_walk_walk");
    ...
    ///<summary>Owen on Morning Walk</summary>
    public InputBooleanEntity OwenOnMorningWalk => new(_haContext, "input_boolean.owen_on_morning_walk");
...
public partial class InputSelectEntities
{
    ...
    public InputSelectEntity HomeState => new(_haContext, "input_select.home_state");
}
...
public partial class NumberEntities
{
    ...
    ///<summary>Main Indicator value</summary>
    public NumberEntity ClimateMainIndicatorValue => new(_haContext, "number.climate_main_indicator_value");
    ///<summary>Deck String Lights Indicator value</summary>
    ...
    ///<summary>Living Room Lamp 1 Indicator value</summary>
    public NumberEntity LivingRoomLamp1IndicatorValue => new(_haContext, "number.living_room_lamp_1_indicator_value");
    ///<summary>Main 0x03 (Ready)</summary>
    public NumberEntity Main0x03Ready => new(_haContext, "number.main_0x03_ready");
...
public partial class SensorEntities
{
    ...
    public SensorEntity BedroomFanNodeStatus => new(_haContext, "sensor.bedroom_fan_node_status");
    ...
    public SensorEntity BedroomLightsNodeStatus => new(_haContext, "sensor.bedroom_lights_node_status");
    ...
    ///<summary>Main Last seen</summary>
    public SensorEntity ClimateMainLastSeen => new(_haContext, "sensor.climate_main_last_seen");
    ///<summary>Main Node status</summary>
    public SensorEntity ClimateMainNodeStatus => new(_haContext, "sensor.climate_main_node_status");
    ...
    public SensorEntity DeckLightsNodeStatus => new(_haContext, "sensor.deck_lights_node_status");
    ...
    public SensorEntity DownstairsLightsNodeStatus => new(_haContext, "sensor.downstairs_lights_node_status");
    ...
    ///<summary>Entry Lights Last seen</summary>
    public SensorEntity EntryLightsLastSeen => new(_haContext, "sensor.entry_lights_last_seen");
    ///<summary>Entry Lights Node status</summary>
    public SensorEntity EntryLightsNodeStatus => new(_haContext, "sensor.entry_lights_node_status");
    ...
    public SensorEntity FrontPorchLightsNodeStatus => new(_haContext, "sensor.front_porch_lights_node_status");
    ...
    public SensorEntity GarageLightsNodeStatus => new(_haContext, "sensor.garage_lights_node_status");
    ...
    ///<summary>Hallway Lights Last seen</summary>
    public SensorEntity HallwayLightsLastSeen => new(_haContext, "sensor.hallway_lights_last_seen");
    ///<summary>Hallway Lights Node status</summary>
    public SensorEntity HallwayLightsNodeStatus => new(_haContext, "sensor.hallway_lights_node_status");
    ...
    public SensorEntity KitchenLightsNodeStatus => new(_haContext, "sensor.kitchen_lights_node_status");
    ...
    public SensorEntity LaundryRoomLightsNodeStatus => new(_haContext, "sensor.laundry_room_lights_node_status");
    ...
    ///<summary>Living Room Lamp 1 Last seen</summary>
    public SensorEntity LivingRoomLamp1LastSeen => new(_haContext, "sensor.living_room_lamp_1_last_seen");
    ///<summary>Living Room Lamp 1 Node status</summary>
    public SensorEntity LivingRoomLamp1NodeStatus => new(_haContext, "sensor.living_room_lamp_1_node_status");
    ///<summary>Living Room Lamp 2 Last seen</summary>
    public SensorEntity LivingRoomLamp2LastSeen => new(_haContext, "sensor.living_room_lamp_2_last_seen");
    ///<summary>Living Room Lamp 2 Node status</summary>
    public SensorEntity LivingRoomLamp2NodeStatus => new(_haContext, "sensor.living_room_lamp_2_node_status");
    public SensorEntity Neptune => new(_haContext, "sensor.neptune");
    ///<summary>Deck String Lights Last seen</summary>
    public SensorEntity Node20LastSeen => new(_haContext, "sensor.node_20_last_seen");
    ...
    ///<summary>Garage Door Tilt Sensor Last seen</summary>
    public SensorEntity Node4LastSeen => new(_haContext, "sensor.node_4_last_seen");
    ///<summary>Garage Door Tilt Sensor Node status</summary>
    public SensorEntity Node4NodeStatus => new(_haContext, "sensor.node_4_node_status");
    ///<summary>Counter Lights Last seen</summary>
    public SensorEntity Node6LastSeen => new(_haContext, "sensor.node_6_last_seen");
    ...
    public SensorEntity OfficeLightsNodeStatus => new(_haContext, "sensor.office_lights_node_status");
    ...
    public SensorEntity StairwayLightsNodeStatus => new(_haContext, "sensor.stairway_lights_node_status");
    ...
    ///<summary>Controller Status</summary>
    ...
    public SensorEntity UtilityRoomLightsNodeStatus => new(_haContext, "sensor.utility_room_lights_node_status");
    ...
    ///<summary>Main Battery level</summary>
    public NumericSensorEntity ClimateMainBatteryLevel => new(_haContext, "sensor.climate_main_battery_level");
    ///<summary>Main Humidity</summary>
    public NumericSensorEntity ClimateMainHumidity => new(_haContext, "sensor.climate_main_humidity");
    ...
    ///<summary>Main Air temperature</summary>
    ...
    ///<summary>Garage Door Tilt Sensor Battery level</summary>
    public NumericSensorEntity ZWavePlusGoldPlatedReliabilityGarageDoorTiltSensorBatteryLevel => new(_haContext, "sensor.z_wave_plus_gold_plated_reliability_garage_door_tilt_sensor_battery_level");
}
...
public partial class SwitchEntities
{
    ...
    ///<summary>Deck String Lights </summary>
    ...
    ///<summary>Entry Lights </summary>
    public SwitchEntity EntryLights => new(_haContext, "switch.entry_lights");
    ...
    ///<summary>Living Room Lamp 1 </summary>
    public SwitchEntity LivingRoomLamp1 => new(_haContext, "switch.living_room_lamp_1");
    ///<summary>Living Room Lamp 2 </summary>
    public SwitchEntity LivingRoomLamp2 => new(_haContext, "switch.living_room_lamp_2");
    ///<summary>Main 0x50 (Node Identify) - Binary</summary>
    public SwitchEntity Main0x50NodeIdentifyBinary => new(_haContext, "switch.main_0x50_node_identify_binary");
...
public partial class UpdateEntities
{
    ...
    public UpdateEntity BedroomFanFirmware => new(_haContext, "update.bedroom_fan_firmware");
    ///<summary>Bedroom Lights Firmware</summary>
    public UpdateEntity BedroomLightsFirmware => new(_haContext, "update.bedroom_lights_firmware");
    ...
    public UpdateEntity ClimateMainFirmware => new(_haContext, "update.climate_main_firmware");
    ///<summary>Counter Lights Firmware</summary>
    public UpdateEntity CounterLightsFirmware3 => new(_haContext, "update.counter_lights_firmware_3");
    ///<summary>Deck Lights Firmware</summary>
    public UpdateEntity DeckLightsFirmware => new(_haContext, "update.deck_lights_firmware");
    ///<summary>Deck String Lights Firmware</summary>
    ...
    public UpdateEntity DiningRoomLightsFirmware => new(_haContext, "update.dining_room_lights_firmware");
    ...
    ///<summary>Entry Lights Firmware</summary>
    public UpdateEntity EntryLightsFirmware => new(_haContext, "update.entry_lights_firmware");
    ...
    public UpdateEntity FrontPorchLightsFirmware => new(_haContext, "update.front_porch_lights_firmware");
    ...
    ///<summary>Hallway Lights Firmware</summary>
    public UpdateEntity HallwayLightsFirmware => new(_haContext, "update.hallway_lights_firmware");
    ...
    ///<summary>Living Room Lamp 1 Firmware</summary>
    public UpdateEntity LivingRoomLamp1Firmware => new(_haContext, "update.living_room_lamp_1_firmware");
    ///<summary>Living Room Lamp 2 Firmware</summary>
    public UpdateEntity LivingRoomLamp2Firmware => new(_haContext, "update.living_room_lamp_2_firmware");
    ...
    public UpdateEntity OfficeLightsFirmware => new(_haContext, "update.office_lights_firmware");
...
public partial class ZoneEntities
{
    ...
    public ZoneEntity Walking => new(_haContext, "zone.walking");
}
...
public partial class LocalFileServices
{
    ...
    ///<param name="target">The target for this service call</param>
    public void UpdateFilePath(ServiceTarget target, LocalFileUpdateFilePathParameters data)
    {
        _haContext.CallService("local_file", "update_file_path", target, data);
    }

    ///<summary>Use this action to change the file displayed by the camera.</summary>
    ///<param name="filePath">The full path to the new image file to be displayed. eg: /config/www/images/image.jpg</param>
    public void UpdateFilePath(ServiceTarget target, string filePath)
    {
        _haContext.CallService("local_file", "update_file_path", target, new LocalFileUpdateFilePathParameters { FilePath = filePath });
    }
}
...
public static class LocalFileEntityExtensionMethods
{
    ///<summary>Use this action to change the file displayed by the camera.</summary>
    public static void UpdateFilePath(this ICameraEntityCore target, LocalFileUpdateFilePathParameters data)
    {
        target.CallService("update_file_path", data);
    }

    ///<summary>Use this action to change the file displayed by the camera.</summary>
    public static void UpdateFilePath(this IEnumerable<ICameraEntityCore> target, LocalFileUpdateFilePathParameters data)
    {
        target.CallService("update_file_path", data);
    }
    ...
    ///<param name="target">The ICameraEntityCore to call this service for</param>
    ///<param name="filePath">The full path to the new image file to be displayed. eg: /config/www/images/image.jpg</param>
    public static void UpdateFilePath(this ICameraEntityCore target, string filePath)
    {
        target.CallService("update_file_path", new LocalFileUpdateFilePathParameters { FilePath = filePath });
    }

    ///<summary>Use this action to change the file displayed by the camera.</summary>
    ///<param name="target">The IEnumerable&lt;ICameraEntityCore&gt; to call this service for</param>
    ///<param name="filePath">The full path to the new image file to be displayed. eg: /config/www/images/image.jpg</param>
    public static void UpdateFilePath(this IEnumerable<ICameraEntityCore> target, string filePath)
    {
        target.CallService("update_file_path", new LocalFileUpdateFilePathParameters { FilePath = filePath });
    }
}
