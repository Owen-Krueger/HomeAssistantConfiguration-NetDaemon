...
public class UnavailableDevices
{
    ...
    public UnavailableDevices(IHaContext context, IScheduler scheduler, ILogger<UnavailableDevices> logger)
    {
        ...
        [
            ...
            new EntityGroup(entities.Switch.LivingRoomLamp1, entities.Button.LivingRoomLamp1Ping, entities.Switch.LivingRoomLamp2),
            new EntityGroup(entities.Switch.LivingRoomLamp2, entities.Button.LivingRoomLamp2Ping, entities.Switch.LivingRoomLamp1),
            ...
            new EntityGroup(entities.Switch.KitchenLights, entities.Button.KitchenLightsPing),
